...
define('DB_HOST', '149.202.88.119');      // Database Host (ჩვეულებრივ localhost)
define('DB_USER', 'gs316885');            // Database Username (შენი username)
define('DB_PASS', 'p9M4tv63pATo');                // Database Password (შენი პაროლი)
define('DB_NAME', 'gs316885');   // Database Name (შენი database-ის სახელი)
